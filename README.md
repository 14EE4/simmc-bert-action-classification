...
이후 3 trials / 2 folds 실행에서 확인된 최적값(`lr=1.9739941119675086e-05`, `weight_decay=0.02266127742232566`, `dropout_rate=0.25346148981751515`)을 기준으로 현재 탐색 범위를 다시 좁혔습니다.

| Hyperparameter | 현재 탐색 범위 |
| --- | --- |
| `lr` | `1.8e-5 ~ 2.2e-5` |
| `weight_decay` | `0.015 ~ 0.035` |
| `dropout_rate` | `0.20 ~ 0.32` |
